      ...
      return (
        ...
        <View style={{backgroundColor : '#4F45F0' , flex:8}}>
            ...
            <View style={{marginTop:20,marginLeft:20}}>
                <Text style={{color:'white',fontSize:22}}>Saved Jobs</Text>
            </View>
                    ...
                    renderItem={({ item }) => 
                        ...
                        <View style={{borderRadius:15,borderWidth:0.5,marginTop:10,backgroundColor:'#0000000a'}}>
                            <View style={{flexDirection:'row'}}>
                                ...
                                <View>
                                <TouchableOpacity onPress={()=>this.onOptionClick(item.id)}   style={{paddingVertical:10,paddingHorizontal:10}}>
                                    <Icon8 name="options-vertical" color={'#4F45F0'} size={24} />
                                </TouchableOpacity>
                                ...
                                <View style={{backgroundColor:'#ffffff5a',right:15,top:55,justifyContent:'center',alignItems:'center',borderRadius:12,width:130,borderWidth:0.8,position:"absolute"}}>
                                    <TouchableOpacity onPress={()=>{item.status == 'Open' ? this.onDeactivatePostClick() : this.onActivatePostClick() }} style={{borderBottomWidth:0.8}}>
                            ...
                            <View style={{flexDirection:'row',marginLeft:20,marginTop:25,marginBottom:15,alignItems:'center',justifyContent:'space-between'}}>
                                ...
                                <View style={{padding:10,alignItems:'center',borderRadius:10,backgroundColor:(item.status == 'Open') ? '#9af5a56a' : '#0000003a'}}>
                                ...
                                </View>
                                {
                                   item.status == 'Open' ? 
                                        <TouchableOpacity onPress={this.onApplyNowClick} style={{flexDirection:'row',alignItems:'center',marginRight:20}}>
                                            <Text style={{color:'#4F45F0',fontSize:17}}>Apply Now</Text>
