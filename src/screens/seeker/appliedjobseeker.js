      ...
      return (
        ...
        <View style={{backgroundColor : '#4F45F0' , flex:8}}>
            ...
            <View style={{marginTop:20,marginLeft:20}}>
                <Text style={{color:'white',fontSize:22}}>Applied Jobs</Text>
            </View>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => 
                        ...
                        <View style={{borderRadius:15,borderWidth:0.5,marginTop:10,backgroundColor:'#0000000a'}}>
                            ...
                            <View style={{flexDirection:'row',marginLeft:20,marginTop:5,marginBottom:15,alignItems:'center',justifyContent:'space-between'}}>
