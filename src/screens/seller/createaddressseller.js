...
export default class Splash extends React.Component {
    ...
    onAddAddressClick(){
        this.dropDownAlertRef.alertWithType('success', 'Address Added !', "",null,1500)
    ...
    render () {
      return (
        ...
        <View style={{marginHorizontal:20,marginTop:10,flexDirection:'row',}}>
                <Text style={{color:'#000',fontSize:20,fontWeight:"bold"}}>Create Address</Text>
        </View>
        ...
        <View style={{marginTop:10,marginHorizontal:20}}>
            ...
            <View style={{marginTop:55}}>
                <Text style={{fontSize:14,color:"#0000005a"}}>State</Text>
            </View>
            <View style={styles.iconInputContainer}>
            <TextInput style = {styles.iconInputField}
                underlineColorAndroid = "transparent"
            ...
            <View style={{marginTop:55}}>
                <Text style={{fontSize:14,color:"#0000005a"}}>Postal Code</Text>
            </View>
            <View style={styles.iconInputContainer}>
            <TextInput style = {styles.iconInputField}
                underlineColorAndroid = "transparent"
            ...
            <TouchableOpacity onPress={this.onAddAddressClick}  style={styles.loginButtonContainer}>
