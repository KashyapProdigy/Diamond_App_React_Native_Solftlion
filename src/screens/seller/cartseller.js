            ...
            renderItem={({ item , index}) => 
                    ...
                    <View style={{backgroundColor:"#fff",elevation:9,marginHorizontal:15,flexDirection:"row",marginVertical:20}}>
                            ...
                            <TouchableOpacity 
                                ...
                                <View style={{marginTop:10,paddingHorizontal:10,backgroundColor:"#fafafa",borderRadius:5,paddingVertical:10,marginBottom:10,alignSelf:"center",alignItems:"center",flexDirection:"row"}}>
