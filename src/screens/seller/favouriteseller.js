...
export default class Splash extends React.Component {
    ...
    onUnsaveProductClick(){
        this.dropDownAlertRef.alertWithType('error', 'Product Unsaved Succcessfully !','',null,1500)
    }
    ...
    render () {
      return (
        ...
        <View style={{marginHorizontal:20,marginTop:10,flexDirection:'row',}}>
                <Text style={{color:'#000',fontSize:20,fontWeight:"bold"}}>Favourite</Text>
        </View>
                        ...
                        style={{backgroundColor:"transparent",marginHorizontal:15,marginVertical:20}}>
                            ...
                            <Image
                                ...
                                style= {{
                                    ...
                                    <Icon5 name="heart" color={'#fff'} size={18} />
                                </TouchableOpacity>
                            </View>
